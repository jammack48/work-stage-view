...
export function ExpandedStagePanel({ stage, jobs, onClose }: ExpandedStagePanelProps) {
  ...
  return (
    <div className="animate-fade-in bg-card rounded-xl shadow-2xl border border-border overflow-hidden">
      ...
      {/* Column headers */}
      <div className="hidden sm:grid gap-4 px-5 py-2 text-xs font-semibold text-muted-foreground uppercase tracking-wider border-b border-border/50 sm:grid-cols-[auto_70px_1fr_1fr_90px_60px]">
        <span className="w-3" />
        <span>ID</span>
        <span>Client</span>
        <span>Job</span>
