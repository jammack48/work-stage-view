...
export function TutorialBanner({ overrideKey }: { overrideKey?: string }) {
  ...
  return (
    <div className="mx-4 sm:mx-6 mt-3 mb-1 rounded-lg border border-primary/30 bg-primary/10 px-4 py-3 flex items-start gap-3 animate-in fade-in slide-in-from-top-2 duration-300">
