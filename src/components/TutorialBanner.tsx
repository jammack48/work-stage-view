...
export function TutorialBanner({ overrideKey }: { overrideKey?: string }) {
  ...
  return (
    <div className="mx-4 sm:mx-6 mt-3 mb-1 rounded-lg border border-sky-300/40 bg-sky-100 dark:bg-sky-950/40 dark:border-sky-500/30 px-4 py-3 flex items-start gap-3 animate-in fade-in slide-in-from-top-2 duration-300">
