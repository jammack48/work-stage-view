  ...
  return (
    <div className="space-y-1 overflow-x-hidden">
      <div className="flex items-center gap-1 min-w-0">
        <Button variant="ghost" size="sm" className="h-9 w-9 sm:h-8 sm:w-8 p-0 shrink-0" onClick={onPrevWeek}>
          <ChevronLeft className="w-5 h-5 sm:w-4 sm:h-4" />
        </Button>
        <div className="grid grid-cols-7 flex-1 min-w-0 gap-1">
          {days.map((d, i) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "relative flex flex-col items-center py-2 px-1 rounded-xl transition-colors font-bold border-2 border-transparent min-w-0",
        ...
        <Button variant="ghost" size="sm" className="h-9 w-9 sm:h-8 sm:w-8 p-0 shrink-0" onClick={onNextWeek}>
